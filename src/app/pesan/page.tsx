        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm">
              Isi form di bawah — konfirmasi & pembayaran via WhatsApp Admin
            </p>
          </div>
          ...
          >
            ...
            <div>
              ...
              {form.metode === 'QRIS' && (
                <p className="mt-2 text-xs text-blue-600 bg-blue-50 border border-blue-100 rounded-lg px-3 py-2">
                  📱 QR Code akan muncul setelah form dikirim. Scan & bayar, lalu konfirmasi ke admin via WhatsApp.
                </p>
              )}
              {form.metode === 'TUNAI' && (
                <p className="mt-2 text-xs text-gray-500 bg-gray-50 border border-gray-100 rounded-lg px-3 py-2">
                  💵 Setelah form dikirim, Anda akan diarahkan ke WhatsApp admin untuk konfirmasi.
                </p>
              )}
            </div>
            ...
            <p className="text-center text-xs text-gray-400">
              {form.metode === 'QRIS'
                ? 'Pesanan disimpan otomatis · QR muncul setelah submit'
                : 'Detail pesanan langsung terkirim ke WhatsApp admin'}
            </p>
          </form>
        </div>
      </div>
