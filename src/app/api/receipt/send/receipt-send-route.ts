...
export async function POST(req: NextRequest) {
  try {
    ...
    const brand = perusahaan === 'BengkuluTravel'
      ? { nama: 'RPM Travel', warna: '#0284c7', from: 'RPM Travel <noreply@rpmtravel.co.id>' }
      : { nama: 'CV. Rafiq Prakasa Performance', warna: '#16a34a', from: 'RPM Travel <noreply@rpmtravel.co.id>' };
...
<div style="max-width:580px;margin:32px auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,.08)">
  ...
  <div style="background:${brand.warna};padding:28px 32px">
    ...
    <p style="color:rgba(255,255,255,.8);font-size:12px;margin:4px 0 0">Jl. S. Parman, Kel. Talang Benih, Curup, Rejang Lebong, Bengkulu</p>
  </div>
  ...
  <div style="background:#f8fafc;border-top:1px solid #e2e8f0;padding:14px 32px;text-align:center">
    <p style="font-size:11px;color:#94a3b8;margin:0">${brand.nama} · Jl. S. Parman, Kel. Talang Benih, Curup, Rejang Lebong, Bengkulu</p>
