      ...
      html: `
        <div style="font-family:sans-serif;max-width:560px;margin:0 auto;">
          <div style="background:#16a34a;padding:24px 32px;border-radius:8px 8px 0 0;">
            ...
            <p style="color:#bbf7d0;margin:4px 0 0;font-size:13px;">E-Ticket / Kwitansi Pembayaran</p>
          </div>
          <div style="background:#f8fafc;padding:24px 32px;border:1px solid #e2e8f0;border-top:none;border-radius:0 0 8px 8px;">
            ...
            <p style="color:#475569;font-size:14px;line-height:1.6;">
              Pembayaran Anda telah dikonfirmasi. Berikut adalah e-ticket perjalanan Anda.
            </p>
            <table style="width:100%;border-collapse:collapse;margin:16px 0;font-size:13px;">
              ...
              <tr style="border-top:2px solid #16a34a;">
                <td style="padding:10px 0;color:#16a34a;font-weight:700;font-size:15px;">TOTAL DIBAYAR</td>
                <td style="color:#16a34a;font-weight:700;font-size:15px;">${formatRupiah(order.totalHarga)}</td>
              </tr>
            </table>
            <p style="color:#475569;font-size:13px;">E-ticket terlampir dalam format PDF. Tunjukkan kepada sopir saat keberangkatan.</p>
