...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://rpmtravel.co.id/sewa-bus-wisata' },
};
...
const faqs = [
  { q: 'Berapa harga sewa bus wisata per hari?', a: 'Harga sewa bus kami Rp 3.000.000 per hari, sudah all-in mencakup BBM dan sopir berlisensi. Tidak ada biaya tambahan tersembunyi selama satu hari penuh pemakaian.' },
  { q: 'Apa saja yang sudah termasuk dalam harga?', a: 'Harga mencakup bahan bakar (bensin/solar) untuk seluruh rute yang disepakati, serta sopir profesional berlisensi resmi yang hafal jalur wisata di area Bengkulu dan sekitarnya. Tiket masuk lokasi wisata, konsumsi, dan akomodasi penumpang tidak termasuk.' },
  { q: 'Berapa kapasitas bus?', a: 'Bus kami menampung 30 penumpang dengan konfigurasi kursi yang memberi ruang gerak cukup — tidak berdesakan seperti minibus. Cocok untuk rombongan sekolah satu kelas atau kelompok kantor ukuran sedang.' },
  { q: 'Apakah bisa sewa lebih dari 1 hari?', a: 'Bisa. Untuk perjalanan multi-hari seperti study tour menginap atau wisata lintas kabupaten, kami menyediakan paket khusus dengan harga yang bisa dinegosiasikan. Hubungi admin kami via WhatsApp untuk simulasi biaya.' },
  { q: 'Bagaimana cara memesan bus?', a: 'Kirim pesan ke WhatsApp 085282828005 dengan menyebutkan tanggal keberangkatan, estimasi rute, dan jumlah penumpang. Admin kami akan konfirmasi ketersediaan dan kirimkan detail pemesanan.' },
];
...
export default function SewaBusWisataPage() {
  return (
    <>
      {/* FIX LCP: Hero + gambar bus dalam satu section */}
        ...
        <div className="max-w-4xl mx-auto px-4 relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center pb-10">
            ...
            <div className="order-last lg:order-first">
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-5 max-w-2xl">
              ...
              <div className="flex flex-wrap gap-3">
                <a href={WA} target="_blank" rel="noopener noreferrer"
                  className="btn-wa px-7 py-3.5 text-base inline-flex items-center gap-2">
            ...
            {/* Gambar hero bus — mobile tampil duluan */}
        ...
        <div className="max-w-4xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="md:col-span-2 space-y-10">
            ...
            <div>
              ...
              <div className="prose prose-sm text-gray-600 space-y-4 mt-4">
                <p>Salah satu tantangan terbesar merencanakan perjalanan rombongan adalah menghitung biaya transportasi yang kerap berubah-ubah — bensin naik, tarif sopir berbeda-beda, dan belum tentu semua tersedia dalam satu paket. RPM Travel hadir dengan pendekatan yang lebih sederhana: satu harga flat Rp 3.000.000 per hari, sudah mencakup BBM dan sopir, titik.</p>
                <p>Bus 30 kursi kami berbasis di Curup, Rejang Lebong, dan siap diberangkatkan ke berbagai tujuan wisata di Bengkulu maupun lintas provinsi. Mulai dari Pantai Panjang, Bukit Kaba, air terjun di kawasan Kepahiang, hingga destinasi religi seperti makam ulama lokal — sopir kami sudah terbiasa dengan rute-rute tersebut.</p>

                {/* Interior bus — lazy load */}
                <div className="not-prose my-6">
                  ...
                  <p className="text-center text-xs text-gray-400 mt-2">Kabin bus kami — kursi lega untuk 30 penumpang, tidak berdesakan seperti minibus.</p>
                </div>

                <p>Untuk sekolah yang menjadwalkan study tour, kami memahami bahwa koordinasi waktu dan jumlah penumpang tidak selalu tepat di angka bulat. Tidak masalah — selama masih dalam kapasitas 30 kursi, Anda bisa berangkat dengan kursi tidak penuh tanpa dikenai biaya tambahan per kursi kosong.</p>
                <p>Bagi instansi atau perusahaan yang rutin mengadakan gathering atau kunjungan lapangan, kami juga melayani pemesanan berulang dengan konfirmasi yang bisa dilakukan jauh hari. Hubungi admin kami via WhatsApp untuk mendiskusikan kebutuhan dan ketersediaan armada.</p>
              </div>
            </div>
          ...
          <div>
            <div className="card p-6 border-2 border-gold-500 sticky top-20">
              ...
              <a href={WA} target="_blank" rel="noopener noreferrer" className="btn-wa w-full py-3 text-sm mb-2 flex items-center justify-center">
                Cek Ketersediaan & Pesan
              </a>
