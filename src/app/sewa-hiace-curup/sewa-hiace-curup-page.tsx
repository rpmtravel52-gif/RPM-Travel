...
const armadaOptions = [
  {
    ...
    // Gambar semua armada Hiace — cocok untuk Regular karena menunjukkan kapasitas
    img: '/images/hiace/all-armada.jpg',
    imgAlt: 'Semua armada Toyota Hiace Regular RPM Travel Curup',
    imgCaption: 'Armada Toyota Hiace Regular RPM Travel — kapasitas 14 penumpang, siap antar rombongan ke mana saja.',
  },
  {
    ...
    // Gambar interior Executive — menunjukkan kenyamanan premium
    img: '/images/hiace/interior.jpg',
    imgAlt: 'Interior kabin Toyota Hiace Executive RPM Travel — kursi premium 8 penumpang leg room ekstra',
    imgCaption: 'Kabin Hiace Executive — hanya 8 kursi dengan leg room ekstra lega, cocok untuk perjalanan dinas dan VIP.',
  },
];

const faqs = [
  { q: 'Apakah harga Rp 1.800.000 sudah termasuk bensin dan sopir?', a: 'Ya, harga Rp 1.800.000 per hari sudah all-in termasuk bahan bakar penuh dan jasa sopir profesional. Tidak ada biaya tambahan tersembunyi.' },
  { q: 'Apakah bisa sewa lebih dari satu hari?', a: 'Tentu bisa. Untuk sewa multi-hari (lebih dari 1 hari), kami menyediakan harga khusus. Hubungi kami via WhatsApp untuk negosiasi paket.' },
  { q: 'Apakah bisa ke luar kota Curup?', a: 'Ya, armada kami bebas digunakan ke mana saja dalam satu hari termasuk ke luar Curup. Untuk perjalanan ke luar Bengkulu atau jarak sangat jauh, mungkin ada penyesuaian biaya.' },
  { q: 'Apakah tersedia untuk malam hari?', a: 'Ketersediaan malam hari tergantung jadwal armada. Konfirmasi terlebih dahulu via WhatsApp untuk memastikan ketersediaan pada waktu yang Anda inginkan.' },
  { q: 'Apa perbedaan Hiace Regular dan Executive?', a: 'Hiace Regular berkapasitas 14 penumpang cocok untuk rombongan besar. Hiace Executive berkapasitas 8 penumpang dengan tempat duduk lebih lega dan kenyamanan premium, cocok untuk perjalanan bisnis atau VIP.' },
];
...
export default function SewaHiaceCurupPage() {
  return (
    <>
      {/* FIX LCP: Hero section dengan gambar semua armada Hiace di dalamnya */}
      <section className="bg-primary-900 pt-10 pb-0 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center pb-10">
            ...
            {/* Gambar semua armada Hiace — mobile tampil duluan (LCP fix) */}
            <div className="order-first lg:order-last">
              <div className="rounded-2xl overflow-hidden shadow-xl ring-1 ring-gold-500/20">
                <Image
                  src="/images/hiace/all-armada.jpg"
                  alt="Semua armada Toyota Hiace RPM Travel Curup — Regular dan Executive"
                  width={900}
                  height={500}
              ...
              <p className="text-center text-xs text-gray-400 mt-2">
                Armada Toyota Hiace RPM Travel Curup — tersedia Regular (14 kursi) dan Executive (8 kursi).
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Pilihan Armada + Gambar masing-masing */}
      <section className="py-14 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {armadaOptions.map(a => (
              <div key={a.tipe} className="border border-gray-200 rounded-2xl overflow-hidden hover:border-gold-400 hover:shadow-md transition-all relative">
                {/* Gambar setiap tipe armada — lazy load karena sudah ada hero di atas */}
                <div className="relative h-48 overflow-hidden bg-primary-900">
                  ...
                  />
                  {a.badge && (
                    <span className="absolute top-3 right-3 bg-gold-500 text-primary-900 text-xs font-bold px-2.5 py-1 rounded-full z-10">
                      {a.badge}
                    </span>
                  )}
                </div>
                <div className="p-6">
                  ...
                  <p className="text-primary-900 font-bold text-lg mb-4">
                    {a.harga}<span className="text-gray-400 text-sm font-normal">/hari</span>
                  </p>
                  ...
                  <p className="text-xs text-gray-400 mb-4 italic">{a.imgCaption}</p>
