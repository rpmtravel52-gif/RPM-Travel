          ...
          <div className="space-y-4">
            <div className="card p-6 border-2 border-gold-500 sticky top-20">
              ...
              <div className="space-y-2 mb-5 text-sm text-gray-600">
                <div className="flex items-center gap-2"><span>✓</span> Antar sampai rumah</div>
                <div className="flex items-center gap-2"><span>✓</span> Harga Sudah Jelas</div>
