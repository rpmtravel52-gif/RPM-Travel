...
const faqs = [
  {
    q: 'Berapa lama perjalanan Palembang ke Lebong?',
    a: 'Estimasi perjalanan dari Palembang ke Lebong sekitar 10–12 jam. Perjalanan melewati jalur lintas Sumatera kemudian masuk ke jalan pegunungan menuju Lebong yang membutuhkan kehati-hatian ekstra dari sopir.',
  },
  {
    q: 'Mengapa ada jadwal keberangkatan pukul 07.00 pagi?',
    a: 'Jadwal pagi pukul 07.00 memungkinkan penumpang tiba di Lebong menjelang sore hari, sehingga masih ada waktu untuk beristirahat atau langsung menuju tujuan akhir. Ini sangat cocok untuk perjalanan yang perlu tiba di Lebong di siang atau sore hari.',
  },
  {
    q: 'Apakah bisa diantarkan ke kecamatan tertentu di Lebong?',
    a: 'Ya, kami berusaha mengantarkan penumpang sedekat mungkin ke tujuan akhir di wilayah Kabupaten Lebong. Informasikan tujuan spesifik Anda saat memesan agar kami bisa mempersiapkan rute terbaik.',
  },
  {
    q: 'Apakah perlu bayar lebih untuk perjalanan subuh?',
    a: 'Harga tiket sama untuk semua jadwal keberangkatan. Hubungi kami untuk informasi harga terkini dan ketersediaan kursi di jadwal yang Anda inginkan.',
  },
  {
    q: 'Apakah keberangkatan malam aman melewati pegunungan Lebong?',
    a: 'Sopir kami sangat berpengalaman dan hafal setiap jalur, termasuk jalan malam hari menuju Lebong. Armada kami juga dilengkapi lampu yang memadai dan selalu dalam kondisi prima.',
  },
];
          ...
          <div className="md:col-span-2 space-y-8">
            <div>
              ...
              <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
                <p>
                  Rute Palembang–Lebong tergolong perjalanan jarak jauh yang membutuhkan armada andal dan sopir berpengalaman. Medan yang dilalui mencakup jalur lintas Sumatera yang panjang dilanjutkan dengan jalan pegunungan menuju Lebong yang menuntut penguasaan jalan yang baik.
                </p>
                <p>
                  RPM Travel memiliki rekam jejak melayani rute-rute panjang di Sumatera dengan penuh tanggung jawab. Setiap sopir kami telah melewati seleksi ketat dan memiliki pengalaman bertahun-tahun di jalur yang sama.
                </p>
              </div>
            </div>
