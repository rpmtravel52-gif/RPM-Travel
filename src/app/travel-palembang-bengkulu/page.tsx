...
export const metadata: Metadata = {
  title: 'Travel Palembang Bengkulu Hiace Executive & Regular | RPM Travel',
  description:
    'Travel Palembang ke Bengkulu dengan Hiace Executive (8 kursi) dan Hiace Regular (14 kursi). Berangkat pukul 10.00 dan 16.00 WIB setiap hari. Door to door. Hubungi RPM Travel 085282828005.',
  keywords: [
  ...
  openGraph: {
    title: 'Travel Palembang Bengkulu Hiace Executive & Regular | RPM Travel',
    description: 'Travel Palembang–Bengkulu dengan Hiace Executive 8 kursi dan Regular 14 kursi. Berangkat 10.00 & 16.00 WIB.',
...
const armadaList = [
  {
    ...
    highlights: ['8 kursi lega & premium', 'Leg room ekstra luas', 'AC berpendingin optimal', 'Cocok perjalanan dinas'],
  },
  {
    tipe: 'Hiace Regular',
    ...
    highlights: ['14 kursi kapasitas besar', 'Bagasi ekstra luas', 'AC berpendingin', 'Harga terjangkau'],
  },
];
...
const faqs = [
  {
    ...
    a: 'Hiace Executive berkapasitas 8 penumpang dengan tempat duduk lebih luas dan leg room ekstra, cocok untuk perjalanan bisnis atau yang menginginkan kenyamanan premium. Hiace Regular berkapasitas 14 penumpang dengan harga lebih terjangkau.',
  },
  {
    q: 'Berapa lama perjalanan Palembang ke Bengkulu?',
    a: 'Estimasi perjalanan sekitar 8–10 jam tergantung kondisi jalan dan lalu lintas lintas Sumatera.',
  },
  {
    q: 'Apakah ada layanan jemput di Palembang?',
    a: 'Ya, kami menyediakan layanan penjemputan di area kota Palembang dan sekitarnya. Informasikan alamat lengkap Anda saat pemesanan.',
  },
  {
    q: 'Apakah perlu memesan jauh-jauh hari?',
    a: 'Disarankan memesan minimal H-1 untuk memastikan ketersediaan kursi, terutama untuk armada Hiace Executive yang kapasitasnya lebih terbatas.',
  },
];
      ...
      <section className="bg-primary-900 py-16 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 relative">
          ...
          <p className="text-gray-300 text-lg leading-relaxed mb-8 max-w-2xl">
            Pilihan perjalanan Palembang–Bengkulu yang fleksibel. Tersedia Hiace Executive untuk kenyamanan premium dan Hiace Regular untuk perjalanan ekonomis bersama rombongan. Dua jadwal keberangkatan setiap harinya.
          </p>
            ...
            {schedules.map(s => (
              <div key={s.jam} className="flex items-center gap-4 bg-primary-900 rounded-2xl p-5">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-xs mt-1">Setiap hari termasuk akhir pekan</p>
                </div>
              </div>
            ))}
          </div>
          <p className="text-gray-500 text-sm bg-yellow-50 border border-yellow-200 rounded-xl px-4 py-3">
            ⚠️ Konfirmasi ketersediaan dan jadwal terkini via WhatsApp sebelum pemesanan.
          </p>
        </div>
      </section>
          ...
          <div>
            <div className="bg-primary-900 rounded-2xl p-6 sticky top-20">
              ...
              <div className="space-y-2 mb-5 text-sm text-gray-300">
                <div className="flex items-center gap-2"><span className="text-gold-400">✓</span> Pilih Executive atau Regular</div>
                <div className="flex items-center gap-2"><span className="text-gold-400">✓</span> 2 jadwal setiap hari</div>
                <div className="flex items-center gap-2"><span className="text-gold-400">✓</span> Door to door Palembang</div>
              </div>
              <a href={WA} target="_blank" rel="noopener noreferrer"
